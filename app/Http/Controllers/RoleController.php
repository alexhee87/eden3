	...
	public function lists(){
        ...
        foreach($roles as $role){
            $rows[] = array(
				...
				'<a href="#" data-href="/role/'.$role->id.'/delete" class="btn btn-xs btn-danger btn-default" onclick="popDeleteMessage(this)"> <i class="fa fa-trash-o" data-toggle="tooltip" title="'.trans('role.destroy').'"></i></a>'.
