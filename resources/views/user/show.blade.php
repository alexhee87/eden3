                ...
                <div class="panel-body full">
                    <div class="row">
                        <div class="col-md-4  col-md-offset-3"
                             style="margin-top:20px;margin-bottom:20px;">{!! getAvatar($user->id,150) !!}</div>
                    </div>
                    <div class="responsive">
                        ...
                        <div class="row" style="padding:10px;">
                            <div class="col-md-6">
                                <a href="#" data-href="{{url('change-password')}}"
                                   class="btn btn-block btn-primary">{{trans('messages.change').' '.trans('messages.password')}}</a>
                            </div>
                            <div class="col-md-6">
        ...
        <div class="col-md-8">
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#social-tab"
                           data-toggle="tab">{{trans('messages.social').' '.trans('messages.networking')}}</a>
                    </li>
                    <li><a href="#custom-field-tab"
                           data-toggle="tab">{{trans('messages.custom').' '.trans('messages.field')}}</a>
                    </li>
                    @if($user->id != Auth::user()->id)
                        <li><a href="#password-tab"
                               data-toggle="tab">{{trans('messages.reset').' '.trans('messages.password')}}</a>
                        </li>
                    @endif
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    {!! Form::input('text','username',$user->Profile->username,['class'=>'form-control','placeholder'=>trans('messages.username').' '.trans('messages.name')])!!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="help-block">This will be used to send two factor auth code.
                                            </div>
                                            <br/>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="file" name="avatar" id="avatar"
                                                   title="{!! trans('messages.select').' '.trans('messages.avatar') !!}"
                                                   class="fileinput"
                                                   data-buttonText="{!! trans('messages.select').' '.trans('messages.avatar') !!}">
                                        </div>
                                    </div>
                                </div>
                                @if($user->Profile->avatar && File::exists(config('constant.upload_path.avatar').$user->Profile->avatar))
                                    <div class="form-group">
                                        <img src="{!! URL::to(config('constant.upload_path.avatar').$user->Profile->avatar) !!}"
