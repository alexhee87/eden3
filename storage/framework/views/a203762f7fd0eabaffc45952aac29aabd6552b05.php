			...
			<div class="tabs-container">
				<div class="tabs-left">
					<ul class="nav nav-tabs">
					  ...
					  <li class="active"><a href="#inbox-tab" data-toggle="tab"><i class="fa fa-inbox"></i> Inbox <span class="label label-warning pull-right"><?php echo e($count_inbox); ?></span></a></li>
